				...
				<div className="flex items-center justify-between">
					...
					<Dialog>
						...
						<DialogContent className="bg-pearl p-4 border-[5px] border-black w-11/12 max-w-5xl">
							<h5 className="bg-purple p-4 text-2xl font-black text-cream">
								Game description
							</h5>
							<div className="grid grid-cols-2 gap-x-4">
								<div className="border-4 border-black rounded-md w-[95%] h-fit">
									<div className="bg-purple-grey p-2">
										<div className="relative ">
											...
											/>
											<div className="absolute top-2 left-2 flex items-center gap-x-4 border-2 rounded-md text-purple-800 border-purple-800 bg-custom-gradient px-4 py-1.5 text-lg font-bold w-fit">
												<Image
								...
								<div className="flex flex-col gap-y-2">
									<h5 className="text-3xl font-black text-purple-800">
										{title}
									</h5>
									<p>
										{type === "onboard"
									...
									<div>
										<h6 className="text-2xl font-bold text-purple-800">
											Know the Stats
										</h6>
										<Image
											src={
									...
									<div className="flex gap-x-2 items-center">
										<Button
											type="submit"
											className="w-full rounded-lg text-lg font-medium h-12 px-8 hover:bg-pink bg-pink border-2 shadow-sm shadow-pink-800 border-pink-800 text-pink-800"
										>
											<Image
												src="/bookmark.svg"
												alt="alt"
